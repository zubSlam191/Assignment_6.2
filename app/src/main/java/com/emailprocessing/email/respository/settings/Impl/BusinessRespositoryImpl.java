 ...
 */
public class BusinessRespositoryImpl extends SQLiteOpenHelper implements EmailsRespository {
    public static final String TABLE_EMAILS = "business";
    ...
    public BusinessRespositoryImpl(Context context) {
